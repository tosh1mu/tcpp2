/**
 * @file head_body_particle_eval_base_m.hpp
 * @brief Evaluation base class of HeadBodyParticle (with model)
...
#ifndef TCPP_HEAD_BODY_PARTICLE_EVAL_BASE_M_HPP_
#define TCPP_HEAD_BODY_PARTICLE_EVAL_BASE_M_HPP_
...
class HeadBodyParticleEvalBaseM: public tcpp::ParticleEvalBaseInterface
{
public:
	HeadBodyParticleEvalBaseM( const cv::Mat& image, int offset_x, int offset_y, double head_area_height_rate,
...
#endif /* TCPP_HEAD_BODY_PARTICLE_EVAL_BASE_M_HPP_ */
