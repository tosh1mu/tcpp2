/**
 * @file head_body_particle_filter.hpp
 * @brief Particle filter for head and body pose tracking
...
#ifndef TCPP_HEAD_BODY_PARTICLE_FILTER_HPP_
#define TCPP_HEAD_BODY_PARTICLE_FILTER_HPP_

#include "head_body_particle/head_body_particle.hpp"
